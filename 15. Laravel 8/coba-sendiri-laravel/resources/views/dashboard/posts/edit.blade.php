    ...
    <div class="col-lg-8">
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="mb-5"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('', $post->slug) }}"
                    readonly>
            </div>
            <div class="mb-3">
                <label for="slug" class="form-label">Slug</label>
            ...
            <div class="mb-3">
                ...
                {{-- simpan images lama untuk dihapus --}}
                <input type="hidden" name="oldImages" value="{{ $post->images }}">

                {{-- jika ada $post->images dari database tampilkan imagenya --}}
                @if ($post->images)
            ...
            <button type="submit" class="btn btn-primary">Udate Post</button>
        </form>
    </div>
    <script>
